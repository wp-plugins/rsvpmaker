...
Description: Schedule events and solicit RSVPs. Editor built around the custom post types feature introduced in WP 3.0, so you get all your familiar post editing tools with a few extra options for setting dates and RSVP options. PayPal payments can be added with a little extra configuration.
Author: David F. Carr
Version: 0.6
...
$wpdb->query("CREATE TABLE IF NOT EXISTS `".$wpdb->prefix."rsvp_dates` (
...
$wpdb->query("CREATE TABLE IF NOT EXISTS `".$wpdb->prefix."rsvpmaker` (
  `id` int(11) NOT NULL auto_increment,
...
$wpdb->query("CREATE TABLE IF NOT EXISTS `".$wpdb->prefix."rsvp_volunteer_time` (
  `id` int(11) NOT NULL auto_increment,
  `event` int(11) NOT NULL default '0',
